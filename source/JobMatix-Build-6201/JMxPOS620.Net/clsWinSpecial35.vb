...
Public Class clsWinSpecial
    ...
    '= grh Jobmatix Setup 3501.1211. 11-Dec-2018==
    '==  WinSpecial Updated for New Setup 3501.
    '==    -- Fixes to GetOsVersion..
    '==    -- Move most stuff into Sub Main....
    '==    -- Add option for silent (Quiet) running..
    '==
    '= = = = = = = = = = = = = = = = = = =
    ...
    ReadOnly Property OsMajorVersion As Integer
        Get
            OsMajorVersion = mOSvi2.dwMajorVersion
        End Get
    End Property  '-major version.-
    '= = = = = = =  = = = = = = = = == =

    ReadOnly Property OsMinorVersion As Integer
        Get
            OsMinorVersion = mOSvi2.dwMinorVersion
        End Get
    End Property  '-major version.-
    '= = = = = = =  = = = = = = = = == =
    '-===FF->
    ...
    Public Sub New()
        ...
        '--  GetVersionEx(ByRef osvi As OSVersionInfoEx) As Boolean

        If Not GetVersionEx(mOSvi2) Then
            Throw New ApplicationException("Can't get window's Version.")
            Exit Sub
        End If

        '-test -
        'MsgBox("OS Version (major/minor) is: " & _
        '                   mOSvi2.dwMajorVersion & "/" & mOSvi2.dwMinorVersion, MsgBoxStyle.Information)
        ...
        Else '--vista or above-
            ...
            msSystemDir = GetKnownFolderPath(FOLDERID_System)
        End If  '-vista-
