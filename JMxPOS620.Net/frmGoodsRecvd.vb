...
Public Class frmGoodsRecvd
    ...
    Private Sub frmGoodsRecvd_Load(ByVal sender As System.Object, _
    ...
    Private Sub frmGoodsRecvd_Resize(ByVal eventSender As System.Object, _
        ...
        If (Me.WindowState <> System.Windows.Forms.FormWindowState.Minimized) Then
            ...
            grpBoxGoods.Height = (Me.Height - 46)
            grpBoxGoods.Width = (Me.Width - 13)

            panelGoodsBanner.Width = grpBoxGoods.Width - 7
            btnStockAdmin.Left = panelGoodsBanner.Width - btnStockAdmin.Width - 5

            panelGoodsHdr.Width = grpBoxGoods.Width - 7

            '= picGoodsItem.Left = panelGoodsHdr.Width - picGoodsItem.Width - 5
            panelPrinting.Left = panelGoodsHdr.Width - panelPrinting.Width - 5

            clsDgvGoodsItems.Width = panelGoodsHdr.Width
            clsDgvGoodsItems.Height = _
                      (grpBoxGoods.Height - panelGoodsBanner.Height - panelGoodsHdr.Height _
                           - panelStockLineEntry.Height - panelGoodsFooter.Height - 65)

            panelGoodsFooter.Top = clsDgvGoodsItems.Top + clsDgvGoodsItems.Height + 3

            panelGoodsFooter.Width = panelGoodsHdr.Width
            panelGoodsTotals.Left = panelGoodsFooter.Width - panelGoodsTotals.Width - 3

            btnGoodsCommit.Top = grpBoxGoods.Height - 41
            btnGoodsCommit.Left = panelGoodsFooter.Width - btnGoodsCommit.Width - 12
            btnGoodsCancel.Left = panelGoodsFooter.Width - btnGoodsCommit.Width - btnGoodsCancel.Width - 24
    ...
    Private Sub btnStockAdmin_Click(ByVal sender As System.Object, _
                                         ByVal e As System.EventArgs) Handles btnStockAdmin.Click
...
datagridSale_Click_Error:
    ...
    Private Function mbPrintPurchaseOrder(Optional ByVal bCapturePDF As Boolean = False, _
        ...
        Try
            ...
            mPrintDocument1.PrinterSettings.PrinterName = msInvoicePrinterName
            '--  start the printer..--
        ...
        If bCapturePDF Then  '- Wait, then send PO to email queue..-
            ...
            If Not gbSaveDocumentToEmailQueue(mCnnSql, sPrintFileFullName, sTitle, "PDF", _
                ...
                MsgBox("Save PO PDF file to Server Queue has failed..", MsgBoxStyle.Exclamation)
            Else  '-  ók=
    ...
    'Private Sub btnTempCancel_Click(sender As Object, e As EventArgs)
    '    '= Call btnGoodsCancel_Click(sender, e)
    '    MsgBox("Will now clear the Grid.", MsgBoxStyle.Information)
