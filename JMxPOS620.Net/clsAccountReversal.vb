...
Public Class clsAccountReversal
    ...
    Public Function CreateAccountReversal(ByVal intOriginalInvoice_id As Integer, _
        ...
        If (sMsg <> "") Then
            ...
            If MsgBox("IMPORANT NOTE-" & vbCrLf & sMsg & vbCrLf & vbCrLf & _
                      "Are you sure you want REVERSE this Invoice ??", _
        ...
        If MessageBox.Show("Please note-" & _
                           "You are about to reverse an Account Sale Invoice with " & _
        ...
        If MessageBox.Show("NB-" & _
                           "This reversal of an Account Sale Invoice can't itself be reversed.. " & _
                                       "Are you sure you want to Reverse the Sale Invoice # " & intOriginalInvoice_id & " ??", _
                            "Confirming Reversal of Account Sale", _
                            MessageBoxButtons.YesNo, MessageBoxIcon.Question, _
                                  MessageBoxDefaultButton.Button2) <> DialogResult.Yes Then
            Exit Function
        End If
        ...
        Else
            ...
            If (dataTable1 IsNot Nothing) AndAlso (dataTable1.Rows.Count > 0) Then
                ...
                For Each datarow1 As DataRow In dataTable1.Rows
                    listOfNonStockItems.Add(datarow1.Item("stock_id"))
                Next datarow1
            End If
        End If
        ...
        '- Check that Invoice is not already reversed..  Set up locking for the Trans.
        ...
        Dim sComments As String = _
                "This is a REVERSAL (Refund) of Account-Invoice No: " & CStr(intOriginalInvoice_id) & ".."
        ...
        Try   '--Main INSERT Try..
            ...
            sValues &= "1, " & CStr(intOriginalInvoice_id) & ", "   '-isOnAccount,  OriginalInvoice.
